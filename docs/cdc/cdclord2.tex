...
\renewcommand{\arraystretch}{1.5}
\begin{longtable}{|c|l|l|l|l|}\hline
\textbf{Icone} & \textbf{Action} & \textbf{Visible depuis...} & \textbf{Visible par...} & \textbf{Commentaire}\\\hline\hline
\endhead
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-report.eps}} & Signaler un problème & Partout & Tous & \\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-help.eps}} & Voir l'aide & Partout & Tous & \\\hline\hline
\raisebox{-3pt}{\includegraphics[width=10pt]{icon-delete.eps}} & Supprimer & Partout & Admin & \\\hline
