...
Le document « spécifications icônes » complète cette annexe, le consulter pour détails supplémentaires. 
  
\subsubsection{Page d'accueil et header}
NB. Ces icônes apparaissent en tracé blanc sur fond sombre. La barre de navigation est présente sur toutes les pages. Les icônes de la page d'accueil ne sont pas cliquables. 

\renewcommand{\arraystretch}{1.5}
\begin{longtable}{|c|l|l|l|l|}\hline
\textbf{Icone} & \textbf{Emplacement} & \textbf{Signification} & \textbf{Commentaire}\\\hline
\endhead
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-fiche.eps}} & Page d'accueil & Fiche individuelle &  \\\hline
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-arbre.eps}} & Page d'accueil & Arbre généalogique &  \\\hline
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-stats.eps}} & Page d'accueil & Statistiques santé &  \\\hline\hline

\raisebox{-3pt}{\includegraphics[width=14pt]{icon-searchbar.eps}} & Barre de navigation & Recherche &  \\\hline
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-home.eps}} & Barre de navigation & Home user &  \\\hline
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-login.eps}} & Barre de navigation & Login &  \\\hline
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-logout.eps}} & Barre de navigation & Logout &  \\\hline

\end{longtable}

\subsubsection{\'Etats}
Apparaissent dans le coin en haut à droite des fiches. Non cliquables.
\renewcommand{\arraystretch}{1.5}
\begin{longtable}{|c|l|l|l|l|}\hline
\textbf{Icone} & \textbf{Objets associés} & \textbf{Signification} & \textbf{Commentaire}\\\hline
\endhead
\raisebox{-1pt}{\includegraphics[width=12pt]{icon-state.eps}} & Listes & Légende « état » & \\\hline
...
\raisebox{-1pt}{\includegraphics[width=12pt]{icon-sex.eps}} & Légende « sexe » dans les listes & \\\hline
...
Apparaissent dans la sidebar ou en bout de ligne dans les listes, déclenchent une action.
    
\begin{longtable}{|c|l|l|l|}\hline
\textbf{Icone} & \textbf{Action} & \textbf{Visible depuis...} & \textbf{Visible par...}\\\hline\hline
\endhead
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-actions.eps}} & Légende « actions » & Listes & Tous\\\hline   
...
\raisebox{0pt}{\includegraphics[width=12pt]{icon-view.eps}} & Voir la fiche & Listes & Tous \\\hline
\raisebox{-3pt}{\includegraphics[width=14pt]{icon-search-rats.eps}} & Voir les rats liés & Objets ayant des rats & Tous\\\hline\hline
 \raisebox{-2pt}{\includegraphics[width=12pt]{icon-profile.eps}} & Voir mon profil utilisateur & Dashboard user & Propriétaire de la fiche\\\hline 
\raisebox{-2pt}{\includegraphics[width=16pt]{icon-three-rats.eps}} & Voir mes rats & Dashboard user & Propriétaire des rats \\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-birth.eps}} & Enregistrer un rat &  Mes rats & Tous\\\hline
\raisebox{-2pt}{\includegraphics[width=14pt]{icon-search-females.eps}} & Voir mes femelles & Mes rats & Propriétaire des rats \\
\raisebox{-2pt}{\includegraphics[width=14pt]{icon-search-males.eps}} & Voir mes mâles & Mes rats & Propriétaire des rats \\
\raisebox{-2pt}{\includegraphics[width=14pt]{icon-search-deceased.eps}} & Voir mes disparus & Mes rats & Propriétaire des rats \\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-rattery.eps}} & Voir mes rateries & Dashboard user & Propriétaire des rateries \\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-birth.eps}} & Voir mes portées & Dashboard user & Propriétaires des rateries \\\hline 
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-backoffice.eps}} & Aller au back-office & Dashboard user & Staff, Admin, Root\\\hline\hline


\raisebox{-2pt}{\includegraphics[width=12pt]{icon-picture.eps}} & Changer la photo & Fiches user, rat, raterie & Propriétaire, Staff \\\hline
...
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-death.eps}} & Déclarer le décès & Fiche rat, Mes Rats & Propriétaire, Créateur, Staff \\
 &  & Mes Rats (liste) & Propriétaire, Créateur, Staff \\\hline\hline

\raisebox{-2pt}{\includegraphics[width=12pt]{icon-print.eps}} & Imprimer & Pedigree rat & Tous\\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-fullscreen.eps}} & Voir en plein écran & Pedigree rat & Tous \\\hline\hline

\raisebox{-2pt}{\includegraphics[width=12pt]{icon-birth.eps}} & Ajouter un raton & Fiche \& listes portées & Tous \\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-rattery.eps}} & Ajouter une contribution & Fiche portée & Propriétaire ? \\\hline
 ...
 & Activer / désactiver la raterie & Fiche raterie, liste rateries & Propriétaire, Staff \\\hline
 & Déménager & Mes rateries, fiche raterie & Propriétaire, Staff\\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-birth.eps}} & Déclarer une portée & Fiche \& liste rateries, mes portées & \\\hline \hline
 
\raisebox{-2pt}{\includegraphics[width=9pt]{icon-lock.eps}} & Verrouiller  & Fiche utilisateur & Admin \\\hline
\raisebox{-1pt}{\includegraphics[width=9pt]{icon-unlock.eps}} & Déverrouiller & Fiche utilisateur & Admin \\\hline
\raisebox{-2pt}{\includegraphics[width=12pt]{icon-email.eps}} & Envoyer un mail & Fiche avec état, listes & \\\hline 
...
\raisebox{-3pt}{\includegraphics[width=10pt]{icon-restore.eps}} & Restaurer le snapshot & Fiche snapshot ?& Staff \\\hline
