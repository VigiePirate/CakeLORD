...
-- dim. 14 juin 2020 17:34:59 CEST
...
CREATE TABLE IF NOT EXISTS `conversations` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_conversations_ratteries1_idx` (`rattery_id` ASC),
  INDEX `fk_conversations_litters1_idx` (`litter_id` ASC),
  INDEX `fk_conversations_rats1_idx` (`rat_id` ASC),
...
CREATE TABLE IF NOT EXISTS `users_conversations` (
  ...
  INDEX `fk_users_has_conversations_conversations1_idx` (`conversation_id` ASC),
...
CREATE TABLE IF NOT EXISTS `contributions` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ratteries_litters_litters1_idx` (`litter_id` ASC),
  INDEX `fk_ratteries_litters_ratteries1_idx` (`rattery_id` ASC),
  ...
  CONSTRAINT `fk_ratteries_has_litters_litters1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_contributions_has_contribution_types1`
