    ...
    public function login() {
        ...
        if ($this->request->is('post')) {
            ...
            if (!empty($user)) {
                ...
                if ($user->failed_login_attempts > 5 & $user->failed_login_last_date->modify('+15 minutes')->isFuture()) { //& $user->failed_login_last_date->modify('+15 minutes')->isFuture() < Chronos::now()
