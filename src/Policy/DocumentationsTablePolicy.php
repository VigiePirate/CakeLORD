 ...
 */
class DocumentationsTablePolicy implements BeforePolicyInterface
{
    /**
     * Open all for admin
     *
    ...
    /**
     * Check if $user can see public list of articles, categories or FAQs
     *
     * @param Authorization\IdentityInterface $user The user.
     * @return bool
     */
    public function canAll(IdentityInterface $user)
    {
        return true;
    }
}
