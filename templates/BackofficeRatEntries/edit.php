...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $backofficeRatEntry->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $backofficeRatEntry->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="backofficeRatEntries form content">
            ...
            <fieldset>
                <legend><?= __('Edit Backoffice Rat Entry') ?></legend>
                <?php
