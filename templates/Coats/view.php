    ...
    <div class="column-responsive column-80">
        <div class="coats view content">
            ...
            <table>
                <tr>
                    <th><?= __('Name Fr') ?></th>
                    <td><?= h($coat->name_fr) ?></td>
                </tr>
                <tr>
                    <th><?= __('Name En') ?></th>
                    <td><?= h($coat->name_en) ?></td>
                </tr>
                <tr>
                    <th><?= __('Picture') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($coat->backoffice_rat_entries)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($coat->backoffice_rat_entries as $backofficeRatEntries) : ?>
                        <tr>
