    ...
    <div class="column-responsive column-80">
        <div class="colors view content">
            ...
            <div class="related">
                ...
                <?php if (!empty($color->backoffice_rat_entries)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($color->backoffice_rat_entries as $backofficeRatEntries) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($color->rats as $rats) : ?>
                        <tr>
                            <td><?= h($rats->id) ?></td>
