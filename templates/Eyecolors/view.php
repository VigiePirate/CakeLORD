    ...
    <div class="column-responsive column-80">
        <div class="eyecolors view content">
            ...
            <div class="related">
                ...
                <?php if (!empty($eyecolor->backoffice_rat_entries)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($eyecolor->backoffice_rat_entries as $backofficeRatEntries) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            <td><?= h($colors->id) ?></td>
                            <td><?= h($colors->name_fr) ?></td>
                            <td><?= h($colors->genotype) ?></td>
                            <td><?= h($colors->name_en) ?></td>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($eyecolor->rats as $rats) : ?>
                        <tr>
                            <td><?= h($rats->id) ?></td>
