    ...
    <div class="column-responsive column-80">
        <div class="markings view content">
            ...
            <table>
                <tr>
                    <th><?= __('Name Fr') ?></th>
                    <td><?= h($marking->name_fr) ?></td>
                </tr>
                <tr>
                    <th><?= __('Name En') ?></th>
                    <td><?= h($marking->name_en) ?></td>
                </tr>
                <tr>
                    <th><?= __('Picture') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($marking->backoffice_rat_entries)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($marking->backoffice_rat_entries as $backofficeRatEntries) : ?>
                        <tr>
