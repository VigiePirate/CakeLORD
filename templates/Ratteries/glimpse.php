...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->image('/img/icon-fa-alert.svg', [
                'url' => ['controller' => 'Ratteries', 'action' => 'sendMessage'],
                'class' => 'side-nav-icon',
                'alt' => __('Report Rattery')]) ?>
            ...
            <?= $this->Html->image('/img/icon-map.svg', [
                'url' => ['controller' => 'Ratteries', 'action' => 'showMap', $rattery->id],
                'class' => 'side-nav-icon',
                'alt' => __('See on Map')]) ?>
            ...
            <?= $this->Html->image('/img/icon-edit-admin.svg', [
                ...
                'class' => 'side-nav-icon',
                'alt' => __('Edit Rattery')]) ?>
            <?= $this->Html->image('/img/icon-check.svg', [
                'url' => ['controller' => 'Ratteries', 'action' => 'changeState', $rattery->id],
                'class' => 'side-nav-icon',
                'alt' => __('Validate Rattery')]) ?>
    ...
    <div class="column-responsive column-90">
        ...
        <h2 class="staff">Conversations</h2>
        <div class="signature">
