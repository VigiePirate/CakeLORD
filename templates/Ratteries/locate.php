    ...
    <div class="column-responsive column-90">
        <div class="rats form content">
            ...
            <?php if (isset($rattery) && (! isset($rattery->latitude) || ! isset($rattery->longitude))) : ?>
                <div class="message error" onclick="this.classList.add('hidden')"><?= __('The rattery you asked for has not recorded its zipcode and therefore, cannot be displayed. Here are the other located ratteries.') ?></div>
            <?php endif; ?>
