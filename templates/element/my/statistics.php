...
<table class="condensed stats">
    <tr>
        ...
        <td><?= is_null($champion) ? 'I have no eligible champion yet' : $this->Html->link(h($champion->usual_name),['controller' => 'Rats', 'action' => 'view', $champion->id]) . ' (' . h($champion->champion_age_string) .')'?></td>
</tr>
</table>
