...
<div class="sheet-markers">
    ...
    <div class="tooltip-state">
        <div class="current-statemark statecolor_<?php echo h($rat->state_id) ?>"><?= h($rat->state->symbol) ?></div>
        <div class="tooltiptext-state" style="background-color:#<?php echo h($rat->state->color) ?>, border-color: transparent transparent transparent #<?php echo h($rat->state->color) ?>;">
            <?= h($rat->state->name) ?>
        </div>
    </div>
    <?php endif; ?>
