...
/**
 * BackofficeRatteryMessagesFixture
 */
class BackofficeRatteryMessagesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_lord_backoffice_rattery_messages_lord_ratteries1' => ['type' => 'index', 'columns' => ['rattery_id'], 'length' => []],
            'fk_lord_backoffice_rattery_messages_lord_users1' => ['type' => 'index', 'columns' => ['staff_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_lord_backoffice_rattery_messages_lord_ratteries1' => ['type' => 'foreign', 'columns' => ['rattery_id'], 'references' => ['ratteries', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_lord_backoffice_rattery_messages_lord_users1' => ['type' => 'foreign', 'columns' => ['staff_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
