...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'Émetteur du message.', 'precision' => null, 'autoIncrement' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => null, 'comment' => ''],
        '_indexes' => [
            'fk_messages_conversations1' => ['type' => 'index', 'columns' => ['conversation_id'], 'length' => []],
            'fk_messages_users1' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
