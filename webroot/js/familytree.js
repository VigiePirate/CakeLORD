...
function setup() {
  ...
  var zoom = d3.behavior.zoom()
    ...
    .translate([window.screen.width/4.5+50, window.screen.height/3]); //.translate([380, 330]);
  ...
  var svg = d3.select("#familytree").append("svg")
    ...
    .attr("transform", "translate(" + (window.screen.width/4.5+50) + "," + window.screen.height/3 + ")"); //.attr("transform", "translate(380,330)");
